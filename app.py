...
def image_to_3d(
    ...
    if use_multi_image:
        ...
        if len(images_to_process) < 2:
            raise gr.Error("Please upload at least two valid images for Multi-Image mode.")
        if len(images_to_process) > 8:
            raise gr.Error("Please upload no more than eight images for Multi-Image mode.")
